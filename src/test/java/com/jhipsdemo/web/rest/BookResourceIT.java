...
import com.jhipsdemo.repository.BookRepository;
import com.jhipsdemo.service.criteria.BookCriteria;
...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).price(DEFAULT_PRICE).publicationDate(DEFAULT_PUBLICATION_DATE);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).price(UPDATED_PRICE).publicationDate(UPDATED_PUBLICATION_DATE);
        return book;
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).price(UPDATED_PRICE).publicationDate(UPDATED_PUBLICATION_DATE);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).price(UPDATED_PRICE).publicationDate(UPDATED_PUBLICATION_DATE);
